...
mymap_o = image.load('images/map-large.png')
mapx = 0
mapy = 10
mapScrollx = 0
mapScrolly = 0
...
def checkInput():
    if keyboard.a or keyboard.LEFT: link.movex = -1
    if keyboard.d or keyboard.RIGHT: link.movex = 1
    if keyboard.w or keyboard.UP: link.movey = -1
    if keyboard.s or keyboard.DOWN: link.movey = 1
